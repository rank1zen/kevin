...
func ChampionItem(ctx context.Context, data ChampionItemData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<tr class=\"h-9\"><td class=\"\"><div class=\"flex h-9 items-center gap-x-1 pr-2\"><div class=\"size-7 flex-none\"></div><div class=\"inline-block truncate overflow-hidden\"><span class=\"truncate text-sm font-semibold text-gray-900/90 dark:text-neutral-100/90\"></span></div></div></td><td class=\"w-18\"><div class=\"w-full pr-2\"><span class=\"truncate font-mono text-sm font-medium text-gray-900/90 dark:text-neutral-100/90\">")
		if templ_7745c5c3_Err != nil {
		...
		if data.LPDelta == nil {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "<span class=\"rounded bg-gray-500/80 px-1 text-xs text-white\">+??</span>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		} else if *data.LPDelta > 0 {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "<span class=\"rounded bg-green-500/80 px-1 text-xs text-white\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "<span class=\"rounded bg-red-500/80 px-1 text-xs text-white\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "<span class=\"rounded bg-gray-500/80 px-1 text-xs text-white\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
