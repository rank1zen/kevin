...
type MatchTeamListData struct {
	Participants []MatchParticipantCardData
}

func MatchTeamList(ctx context.Context, data MatchTeamListData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, data := range data.Participants {
			templ_7745c5c3_Err = MatchParticipantCard(ctx, data).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
